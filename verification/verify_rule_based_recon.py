"""Renders the new coverage-driven RECON behavior in RuleBasedBlueRolePlanner (see
...
RuleBasedBlueRolePlanner with recon_fraction/min_recon enabled, so the RECON
...
from planning.planner import RuleBasedBlueRolePlanner
from simulation.testbed import Simulation
from verification.verify_recon_fov_pov import render_pov_gif
