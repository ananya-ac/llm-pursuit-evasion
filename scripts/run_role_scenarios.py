...
from planning.planner import BlueRolePlanner, _infer_stride
...
class ReconThenNeutralizePlanner(BlueRolePlanner):
    ...
    def plan(self, obs):
        ...
        if not self.spotted:
            self.last_target_red_ids = {}
            return {i: BlueRole.RECON for i in active_blues}
        ...
        return {i: BlueRole.NEUTRALIZE for i in active_blues}
